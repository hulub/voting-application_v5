...
public class ConfirmRingSignMessageState extends AbstractHardwareWalletState {
	...
	protected void internalTransition(HardwareWalletClient client, HardwareWalletContext context, MessageEvent event) {
		...
		case MESSAGE_SIGNATURE:
			...
			HardwareWalletEvents.fireHardwareWalletEvent(HardwareWalletEventType.MESSAGE_SIGNATURE,
					event.getMessage().get(), client.name());
			break;
		/* Ring Sign Message */
